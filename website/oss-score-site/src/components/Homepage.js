    ...
    return (
        <div className="Home">
            ...
            <form onSubmit={handleSubmit}>
                <div class="searchbar">
                    <div>
                        <input type="text" key="search1" id="search1" name="search1" placeholder="Insert Github Repo 1" onClick={() => document.getElementById('search1').style.borderColor = '#000000'}
                    ...
                    <div>
                        <input type="text"  key="search2" id="search2" name="search2" placeholder="Insert Github Repo 2" onClick={() => document.getElementById('search2').style.borderColor = '#000000'}
