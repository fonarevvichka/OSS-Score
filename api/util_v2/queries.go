...
func GetCoreRepoInfo(client *http.Client, repo *RepoInfo) {
	query := importQuery("./util_v2/queries/repoInfo.graphql") //TODO: Make this a an env var probably
...
func GetGithubDependencies(client *http.Client, repo *RepoInfo) {
	query := importQuery("./util_v2/queries/dependencies.graphql") //TODO: Make this a an env var probably
...
func GetGithubIssuesGraphQL(client *http.Client, repo *RepoInfo, startDate string) {
	query := importQuery("./util_v2/queries/issues.graphql") //TODO: Make this a an env var probably
...
func GetGithubCommits(client *http.Client, repo *RepoInfo, startDate string) {
	query := importQuery("./util_v2/queries/commits.graphql") //TODO: Make this a an env var probably
...
func GetGithubReleases(client *http.Client, repo *RepoInfo, startDate string) {
	query := importQuery("./util_v2/queries/releases.graphql") //TODO: Make this a an env var probably
