...
function insertHTML(scoreDiv, scores, state) {
    let header = "<h2 class=\"h4 mb-3\"> <a style='text-decoration: none; color: rgb(0,0,0)' href='https://oss-score-website.heroku.com/generate-scores'>OSS Score</a> </h2>";
    ...
    if (isDark) {
        ...
        header = "<h2 class=\"h4 mb-3\"> <a style='text-decoration: none; color: rgb(201,209,217)' href='https://oss-score-website.heroku.com'>OSS Score</a> </h2>";
